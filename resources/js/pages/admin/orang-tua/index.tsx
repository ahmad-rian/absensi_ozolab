    ...
    function handleSearch(value: string) {
        ...
        router.get(
            '/admin/orang-tua',
            {
                ...
                belum_login: filters.belum_login || undefined,
            },
        ...
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4 md:p-6">
                ...
                <label className="flex items-center gap-2 text-sm">
                    <input
                        type="checkbox"
                        checked={filters.belum_login}
                        onChange={(event) =>
                            router.get('/admin/orang-tua', {
                                search,
                                belum_login: event.target.checked
                                    ? 1
                                    : undefined,
                            })
                        }
                    />{' '}
                    Hanya yang belum bisa login
                </label>
                {/* Table */}
                                    ...
                                    <TableRow key={parent.id}>
                                        ...
                                        <TableCell className="text-right">
                                            <div className="flex items-center justify-end gap-1">
                                                ...
                                                >
                                                    <Link
                                                        href={`/admin/orang-tua/${parent.id}`}
                                                    >
                                                ...
                                                >
                                                    <Link
                                                        href={`/admin/orang-tua/${parent.id}/edit`}
                                                    >
                ...
                {parents.last_page > 1 && (
                    <div className="flex items-center justify-between">
                        <p className="text-sm text-muted-foreground">
                            Menampilkan {parents.from} - {parents.to} dari{' '}
                            {parents.total} data
                        </p>
