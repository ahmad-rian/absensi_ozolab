                ...
                <form onSubmit={handleSubmit} className="mx-auto w-full max-w-2xl space-y-6">
                        ...
                        <CardContent className="grid gap-4 sm:grid-cols-2">
                            ...
                            <div className="grid gap-2">
                                ...
                                <div className="flex">
                                    ...
                                    <Input inputMode="numeric" value={data.phone} onChange={(e) => setData('phone', e.target.value.replace(/\D/g, ''))} className="rounded-l-none" />
                                </div>
                    ...
                    <Card>
                        ...
                        <CardContent className="grid gap-4 sm:grid-cols-2">
                            <div className="grid gap-2">
                                <Label>NIK</Label>
                                <Input inputMode="numeric" value={data.nik} onChange={(e) => setData('nik', e.target.value.replace(/\D/g, ''))} />
