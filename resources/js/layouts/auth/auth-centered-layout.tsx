...
export default function AuthCenteredLayout({
    ...
    const passwordRequired = page.component === 'auth/ganti-password';
    ...
    return (
        <div className="relative flex min-h-dvh flex-col items-center justify-center overflow-hidden bg-zinc-50 px-4 py-10 sm:px-6 dark:bg-zinc-950">
            ...
            <div
                aria-hidden="true"
                className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_right,theme(colors.zinc.200)_1px,transparent_1px),linear-gradient(to_bottom,theme(colors.zinc.200)_1px,transparent_1px)] [mask-image:radial-gradient(ellipse_at_center,black_20%,transparent_75%)] bg-[size:44px_44px] opacity-60 dark:bg-[linear-gradient(to_right,theme(colors.zinc.800)_1px,transparent_1px),linear-gradient(to_bottom,theme(colors.zinc.800)_1px,transparent_1px)] dark:opacity-40"
            />
            ...
            <div
                aria-hidden="true"
                className="pointer-events-none absolute right-[-10%] -bottom-48 -z-0 h-[34rem] w-[34rem] rounded-full bg-gradient-to-tl from-indigo-400/20 via-sky-400/15 to-transparent blur-3xl dark:from-indigo-600/15 dark:via-sky-600/10"
            />
